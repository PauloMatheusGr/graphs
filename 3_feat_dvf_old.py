#!/usr/bin/env python3
"""
ARCHIVED (legado) — features DVF de warps visita → template CN.

Pastas / saídas deste script:
  warps:  images/displacement_field/          (via 3_feat_gen_dvf_old.py)
  out:    csvs/cohorts/all_population/features_displacement.csv
  run:    images/displacement_field/features/{COHORT}/

Pipeline atual (baseline do paciente como fixed): ver 3_feat_gen_dvf.py + 3_feat_dvf.py.
