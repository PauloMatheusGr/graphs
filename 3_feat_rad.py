...
- Por padrao: binCount=64 (MRI; evita binWidth=25 do default CT, que explode Ng).
...
def make_extractor(params: Path | None, *, bin_width: float | None) -> Any:
    ...
    return featureextractor.RadiomicsFeatureExtractor(binCount=int(DEFAULT_BIN_COUNT))
