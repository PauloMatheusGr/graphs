#!/usr/bin/env python3
"""
ARCHIVED (legado) — warp visita → template CN estratificado.

Pastas / saídas deste script:
  warps:  images/displacement_field/
  feats:  csvs/cohorts/all_population/features_displacement.csv  (via 3_feat_dvf_old.py)
...
A extração de atributos por ROI é feita separadamente por 3_feat_dvf_old.py,
