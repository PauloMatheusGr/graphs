...
population_file = "csvs/adnimerged_longitudinal_window_extremos.csv" #"image_data.txt"
...
regions_dir = "/mnt/study-data/pgirardi/graphs/images/reregions" #"/mnt/databases/mri/adni/preproc/5-parcellation/regions"
